...
ElaNavigationRouter::ElaNavigationRouter(QObject *parent)
    : QObject{parent}
    , d_ptr(new ElaNavigationRouterPrivate())
{
    ...
    Qt::ConnectionType connectionType)
{
    ...
    saveData.insert("ElaRouteConnectionType",
                    QVariant::fromValue<Qt::ConnectionType>(connectionType));
...
void ElaNavigationRouter::navigationRouteBack()
{
    ...
    if (routeQueneCount > 0) {
        ...
        Qt::ConnectionType connectionType = routeSaveData.value("ElaRouteConnectionType")
                                                .value<Qt::ConnectionType>();
        QMetaObject::invokeMethod(routeObject,
                                  routeFunctionName.toLocal8Bit().constData(),
                                  connectionType,
