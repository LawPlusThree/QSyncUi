    ...
    , d_ptr(new ElaWidgetPrivate())
{
    ...
    d->_appBar->setWindowButtonFlags(
        ElaAppBarType::StayTopButtonHint | ElaAppBarType::MinimizeButtonHint
    ...
    connect(d->_appBar, &ElaAppBar::closeButtonClicked, this, [=]() { hide(); });
    ...
    connect(ElaApplication::getInstance(),
            ...
            d,
            &ElaWidgetPrivate::onThemeModeChanged);
}
