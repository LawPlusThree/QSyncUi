...
ElaGraphicsLineItem::ElaGraphicsLineItem(ElaGraphicsItem *startItem,
                                         ElaGraphicsItem *endItem,
                                         int startItemPort,
                                         int endItemPort,
...
bool ElaGraphicsLineItem::isTargetLink(ElaGraphicsItem *item1,
...
void ElaGraphicsLineItem::paint(QPainter *painter,
                                ...
                                QWidget *widget)
{
    ...
    path.cubicTo((pathXStart + pathXEnd) / 2,
                 pathYStart,
                 (pathXStart + pathXEnd) / 2,
                 pathYEnd,
                 pathXEnd,
                 pathYEnd);
    setPath(path);
